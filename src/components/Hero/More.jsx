...
function More() {
  return (
    <div className="absolute hidden lg:flex bottom-[-3%] md:gap-[500px] gap-[100px] lg:gap-[550px] md:left-[23%] items-center z-10 py-4 border-0 justify-between border bg-[#1c6ce4]">
